...
class Detector(object):
    def __init__(self):
        ...
        self.yolov2=Yolo2("Yolo2/cfg/yolo.cfg", "Yolo2/yolo.weights",is_xywh=True)
        ...
        self.class_names = self.yolov2.class_names
    ...
    def detect(self):
        ...
        while self.vdo.grab(): 
            ...
            bbox_xywh, cls_conf, cls_ids = self.yolov2(im)
